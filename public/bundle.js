	...
	var List = _react2.default.createClass({
	  ...
	  *************************************************************************************/
			...
			var listItems = this.props.items.map(function (item, i) {
				return _react2.default.createElement(
					'li',
					{ className: 'list-group-item', style: styles.listGroup, key: i },
					_react2.default.createElement('span', { className: 'glyphicon glyphicon-remove', style: styles.removeItem, onClick: _this.props.remove.bind(null, i) }),
					_react2.default.createElement(
						'span',
